...
void BuildDeviceConsoleOutput(XInputDevice_t& device)
{
    ...
    sprintf_s(device.consoleBuffer[DEVICE_STATE_LEFTTRIGGER]          , "  - LTrigger : %hu"    , device.state.XinputState.Gamepad.bLeftTrigger);
    sprintf_s(device.consoleBuffer[DEVICE_STATE_RIGHTTRIGGER]         , "  - RTrigger : %hu"    , device.state.XinputState.Gamepad.bRightTrigger);
